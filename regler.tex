...
Första rundan gäller det att ta stick som man ska spela med under andra omgången.
...
Spelaren lägger ut ett kort framför sig enligt följande regler (högre prio ju högre i listan):
\begin{itemize}
  ...
  \item Spelaren lägger ett kort från handen och tar ett nytt från högen eller chansar och drar ett från högen och lägger på bordet
\end{itemize}
...
\begin{itemize}
  ...
  \item Trumf får läggas på övriga färger och på trumf
